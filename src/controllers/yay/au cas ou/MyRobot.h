...
// Right-corner odometry calibration constants.
// Change X/Y if your measured corner coordinates are different.
#define BACK_RIGHT_CORNER_HEADING -2.35779
#define BACK_RIGHT_CORNER_X       -6.0
#define BACK_RIGHT_CORNER_Y       -3.0
#define CORNER_TURN_SPEED         1.2
#define CORNER_APPROACH_SPEED     2.0
#define CORNER_FRONT_THRESHOLD    900.0
#define CORNER_APPROACH_TIMEOUT   500
...
private:
    ...
    // Right-corner odometry calibration state.
    bool _corner_aligned;
    int  _corner_drive_steps;

    // Legacy look-back-right test state kept for compatibility.
    bool _look_back_right_active;
    double _look_back_right_target;
    ...
    void reset_odometry_at_right_corner();
